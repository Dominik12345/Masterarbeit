...
\section{Matching mit dem Standardmodell}
  ...
  \subsection{Extrapolation von $\alpha^{*3}$}
    ...
    Kopplung für hohe Energien fällt. Aus Abbildung \ref{fig:messbarkeit:afix3} 
    wird klar, dass sich $\alpha_1$ und $\alpha$ qualitativ völlig 
  ...
  \subsection{Extrapolation von $\alpha^{*4}$}
    ...
    Die laufenden Kopplungen für die Modelle a bis e (vgl. Tabelle 
    ...
    \ref{fig:messbarkeit:relative_deviation}.
