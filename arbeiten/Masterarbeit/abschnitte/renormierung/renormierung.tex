...
\section{Quantenfeldtheorie und Standardmodell}
  ...
  \subsection{Effektive Quantenwirkung und Gell-Mann-Low Gleichung}
    ...
    Hilfe von erzeugenden Funktionalen gezeigt, vgl. \cite{Zinn}. 
    Zunächst werden die erzeugenden Funktionale $Z$ und $W$ eingeführt um 
    die Gluon-2-Punkt Funktion zu berechnen. Aus der Rechnung wird die 
    ...
    Die Rechnung erfolgt am Beispiel einer skalaren $SU(N)$ mit reellen, 
    ...
    \begin{equation}
     ...
     \frac12 \left(\left[\i \partial_\mu-g t^A_{ji} \mathcal{A}^A_\mu
     \right]\phi_i\right)^*
     \left(\left[\i \partial^\mu-g t^A_{ji} \mathcal{A}^{A\,\,\,\mu}
     \right]\phi_i\right)
     -
     \frac14 F^{A\,\,\, \mu\nu} F_{\mu\nu}^A
    \end{equation}
    ...
    \begin{align}
     ...
     \A^{A\,\,\, \mu} \partial_\nu \A^{A\,\,\, \nu} \\
     S_1[\phi,\A]&= \dx 2\i g  \partial^\mu \phi_j t_{ji}^A \phi_i \A_\mu^A 
    \end{align}
    ableiten. Gluon-Selbstwechselwirkungen sollen hier nicht betrachtet werden, 
    außerdem wurde eine reelle Darstellung gewählt, sodass $\phi^*=\phi$ und 
    $(t^A_{ji})^*=(-t^A_{ji})$. 
    ...
    $\mathcal{O}(g^1)$}
      ...
      Es soll nun der Gluonpropagator als $\langle \A^A_\mu(x_1)\A^B_\nu(x_2) 
      \rangle= Z^{(0,2)\,\,\, AB}_{\mu\nu}(x_1,x_2)$ rekonstruiert werden. 
      ...
      \end{equation}
      geschrieben werden. Mit \eqref{eq:renormierung:ableitungen} gilt dann 
      \begin{equation}
       Z^{(0,2)\,\,\, AB}_{\mu\nu}(x_1,x_2) = 
    ...
    \begin{equation}
    \begin{aligned}
      Z[J,J_\mu]&= -2 g^2 t^C_{ji}t^D_{lk} \int \d^D y_1 \d^D y_2 
     \left(\partial^\rho \frac{\delta}{\i\delta J_j(y_1)} \right)  \frac{\delta}{\i \delta 
     J_i(y_1)} \frac{\delta}{\i \delta J^C_\rho(y_1)} \\&
     \left(\partial^\sigma \frac{\delta}{\i\delta J_l(y_2)} \right)   \frac{\delta}{\i \delta 
...
%      
    ...
    \begin{equation}
     \begin{aligned}
      &Z^{(0,2)\,\,\, AB}_{\mu\nu}(x_1,x_2) = -2 g^2 t^C_{ji}t^D_{lk}
      \int \d^D y_1 \,\,\, d^D y_2 \,\,\,
      \\ &
      \left[
    ...
    \begin{aligned}
    W^{(0,2)\,\,\, AB}_{\mu\nu} (x_1,x_2) &= 
    4g^2 \text{Tr}(t^A t^B) \int \d^D y_1 \,\,\, d^D y_2 \,\,\, 
    \Delta^{\mu\rho}(x_1,y_1)\Delta^{\nu \sigma}(x_2,y_2)
    \\&\left[
       \Delta(y_1,y_2)
       \partial_\rho 
    ...
    \begin{aligned}
     ...
     4 g^2 \text{Tr}(t^A t^B) \frac{1}{(2\uppi)^{3D}} 
     \frac{\delta(k_1+k_2)}{k_1^4} \int \frac{\d^D q}{(2\uppi)^D} \,\,\, \\ &
   ...
   \begin{equation}
    ...
    \end{align}
    schreiben. Durch die Wahl $4\uppi \e^{-\gamma_\text{E}}
      ...
      \end{equation}
      Dabei wurde die Gruppenkonstante $T(S) \delta^{AB}=\text{Tr}(t^At^B)$ 
      eingeführt.
      Die Renormierungskonstante $Z_\A$ ist nun
      \begin{equation}
       Z_\A = 1-\frac{g_\text{R}^2}{16 \uppi^2} \frac{2}{3} T(S) \quad .
      \end{equation}
      ...
      \begin{equation}
       \beta(g):= \mu \frac{\d g}{\d\mu} = \frac{g_\text{R}^3}{16 \uppi^2}
       \frac{2}{3} T(S) + \mathcal{O}(g^5) \quad .
      \end{equation}
