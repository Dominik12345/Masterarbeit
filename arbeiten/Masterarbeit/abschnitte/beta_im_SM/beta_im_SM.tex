\subsection{Laufende Kopplung in der Standardmodell QCD}\label{beta_im_SM}
   ...
   quadratische
   \newpage
   Casimiroperator der adjungierten Darstellung. Im SM 
   gibt es $d(S)=0$ Skalare mit
   Colour-Ladung, $d(F)=n_\text{f}$ Dirac-Fermionen und 
